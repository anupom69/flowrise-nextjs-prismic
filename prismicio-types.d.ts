...
type FeaturesPageDocumentDataSlicesSlice =
  | CallToActionSlice
  | TestimonialsSlice
  | FeaturesSlice
  | TextWithImageSlice;
...
/**
 * Content for Features Page documents
 */
interface FeaturesPageDocumentData {
  /**
   * Slice Zone field in *Features Page*
   *
   * - **Field Type**: Slice Zone
   * - **Placeholder**: *None*
   * - **API ID Path**: features_page.slices[]
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#slices
   */
  slices: prismic.SliceZone<FeaturesPageDocumentDataSlicesSlice> /**
   * Meta Title field in *Features Page*
   *
   * - **Field Type**: Text
   * - **Placeholder**: A title of the page used for social media and search engines
   * - **API ID Path**: features_page.meta_title
   * - **Tab**: SEO & Metadata
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */;
  meta_title: prismic.KeyTextField;
  ...
  /**
   * Meta Description field in *Features Page*
   *
   * - **Field Type**: Text
   * - **Placeholder**: A brief summary of the page
   * - **API ID Path**: features_page.meta_description
   * - **Tab**: SEO & Metadata
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  meta_description: prismic.KeyTextField;
  ...
  /**
   * Meta Image field in *Features Page*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: features_page.meta_image
   * - **Tab**: SEO & Metadata
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  meta_image: prismic.ImageField<never>;
...
/**
 * Features Page document from Prismic
 *
 * - **API ID**: `features_page`
 * - **Repeatable**: `false`
 * - **Documentation**: https://prismic.io/docs/custom-types
 *
 * @typeParam Lang - Language API ID of the document.
 */
export type FeaturesPageDocument<Lang extends string = string> =
  prismic.PrismicDocumentWithoutUID<
    Simplify<FeaturesPageDocumentData>,
    "features_page",
    Lang
  >;
...
export type AllDocumentTypes =
  | AboutPageDocument
  | FeaturesPageDocument
  | HomepageDocument
  | SettingsDocument
  | TestimonialDocument;

/**
 * Item in *CallToAction → Default → Primary → Action Button*
 */
export interface CallToActionSliceDefaultPrimaryActionButtonItem {
  /**
   * Button Name field in *CallToAction → Default → Primary → Action Button*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: call_to_action.default.primary.action_button[].button_name
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  button_name: prismic.KeyTextField;

  /**
   * Button Link field in *CallToAction → Default → Primary → Action Button*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: call_to_action.default.primary.action_button[].button_link
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
...
export interface CallToActionSliceDefaultPrimary {
  ...
  /**
   * Action Button field in *CallToAction → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: call_to_action.default.primary.action_button[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  action_button: prismic.GroupField<
    Simplify<CallToActionSliceDefaultPrimaryActionButtonItem>
  >;
}
...
/**
 * Item in *Testimonials → Default → Primary → Repeatable Testimonials*
 */
export interface TestimonialsSliceDefaultPrimaryRepeatableTestimonialsItem {
  /**
   * Testimonial field in *Testimonials → Default → Primary → Repeatable Testimonials*
   *
   * - **Field Type**: Content Relationship
   * - **Placeholder**: *None*
   * - **API ID Path**: testimonials.default.primary.repeatable_testimonials[].testimonial
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
...
export interface TestimonialsSliceDefaultPrimary {
  ...
  /**
   * Repeatable Testimonials field in *Testimonials → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: testimonials.default.primary.repeatable_testimonials[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  repeatable_testimonials: prismic.GroupField<
    Simplify<TestimonialsSliceDefaultPrimaryRepeatableTestimonialsItem>
  >;
}
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      FeaturesPageDocument,
      FeaturesPageDocumentData,
      FeaturesPageDocumentDataSlicesSlice,
      HomepageDocument,
      ...
      AllDocumentTypes,
      CallToActionSlice,
      CallToActionSliceDefaultPrimaryActionButtonItem,
      ...
      HeroSliceHorizontal,
      TestimonialsSlice,
      TestimonialsSliceDefaultPrimaryRepeatableTestimonialsItem,
